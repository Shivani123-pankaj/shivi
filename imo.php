...
<nav id="progress">
<ul class="pagination">
<li class="active"><a href="#">&nbsp;&nbsp;&nbsp;IMO?NGO Details &nbsp;&nbsp;&nbsp;
<span class="sr-only">(current)</span></a></li>
<li class="disabled"><a href="#">&nbsp;&nbsp;&nbsp;Registration Details&nbsp;&nbsp;&nbsp;
<span class="sr-only">(current)</span></a></li>
<li class="disabled"><a href="#">&nbsp;&nbsp;&nbsp;Document Upload &nbsp;&nbsp;&nbsp;
<span class="sr-only">(current)</span></a></li>
<li class="disabled"><a href="#">&nbsp;&nbsp;&nbsp;Business Details&nbsp;&nbsp;&nbsp;
<span class="sr-only">(current)</span></a></li>
</ul>
</nav>
</div>
...
<form action="imo-details-reg.php" method="post">
      <br>
 <center><b><span style="font-size:25px;">IMO Details</span></b></center>
 <hr>
